...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      title: "My Skills - My Portfolio",
      description: "Discover the technologies and tools I excel in.",
      url: "https://my-portfolio-website-chi-dusky.vercel.app/skills",
      siteName: "My Portfolio",
      images: [
        {
          url: "https://my-portfolio-website-chi-dusky.vercel.app/images/skills-og.png", // Replace with your actual OG image URL
          width: 1200,
          height: 630,
          alt: "Skills",
        },
